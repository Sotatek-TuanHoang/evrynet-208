...
do
  ...
  gev --datadir ./tests/test_nodes/node"$i"/data --rpccorsdomain "*" --targetgaslimit '900000000000000' --nodiscover --tendermint.blockperiod 5 --syncmode full --networkid 15 --mine \
